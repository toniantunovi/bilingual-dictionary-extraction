...
def read_dict(dict_file):
    dict = json.load(codecs.open(dict_file, 'r', encoding='utf8'))
    return [tuple([key, value]) for key, value in dict.iteritems()]
...
def score(sp1, sp2, gold, additional, printInfo=False):
    ...
    return [ prec_at(ranks, 1), prec_at(ranks, 5), prec_at(ranks, 10) ]
